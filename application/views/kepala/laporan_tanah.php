    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div class="container-fluid">
        <div class="alert bg-content" role="alert">
          <i class="fas fa-newspaper"></i> Laporan Aset Tanah <b style="text-transform: uppercase;"><?= $bidang; ?></b>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-md-8">
            <div class="card mb-2 py-1 border-left-danger">
                ...
                <form method="post" action="<?php echo base_url('kepala/dashboard/laporan_all_tanah/'.$id_bidang) ?>" target="_blank">
