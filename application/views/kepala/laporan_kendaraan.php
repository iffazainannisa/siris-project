    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div class="container-fluid">
        <div class="alert bg-content" role="alert">
          <i class="fas fa-newspaper"></i> Laporan Aset Kendaraan <b style="text-transform: uppercase;"><?= $bidang; ?></b>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-md-8">
            <div class="card mb-2 py-1 border-left-danger">
                <div class="card-body">
                  <h5><i class="fas fa-vote-yea"></i> <b >Laporan Inventaris</b></h5>
                  <div class="garis" style="width: 100%; margin-bottom: 2%;"></div>
                </div>
                <form method="post" action="<?php echo base_url('kepala/dashboard/laporan_all_kendaraan/'.$id_bidang) ?>" target="_blank">
                  ...
                  <button type="submit" name="edit" class="btn btn-success btn-sm ml-3 mb-3"><i class="fas fa-eye"></i> Lihat</button>
                  <br />
                </form>
            </div>
          </div>
