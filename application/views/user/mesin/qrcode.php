        ...
        <div class="row">
            ...
            <div class="col-md-6">
              <div class="card mb-4 py-3 border-left-danger">
                <div class="card-body">
                  ...
                  <b> <nav aria-label="breadcrumb">
                        <ol class="breadcrumb" style="background: #fce6e8;">
                          <li class="breadcrumb-item"><?php echo anchor('user/mesin/inventaris','<i class="fas fa-qrcode"></i> Kelola Inventaris'); ?></li>
                ...
                <center>
                   <form method="post" action="<?php echo base_url('user/mesin/print_qrcode_custom') ?>" target="_blank">
                        <div class="form-group">
                          <label class="col-form-label">Masukkan Jumlah</label>
                            <?php echo form_hidden('stock', $idin->jumlah_baik); ?>
                            <?php echo form_hidden('id_inventaris', $idin->id_inventaris); ?>
                            <input type="number" name="jumlah" value="<?= $idin->jumlah_baik;?>" class="form-control" style="width: 30%;" required>
