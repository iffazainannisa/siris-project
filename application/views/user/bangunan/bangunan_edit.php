    ...
    <div id="content-wrapper" class="d-flex flex-column bg-picture">
      ...
      <div class="container-fluid">
        <div class="alert bg-content" role="alert">
          <i class="fas fa-plus-square"></i> Kelola Aset Bangunan
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
              <div class="card mb-4 py-3 border-left-danger">
                <div class="card-body">
                  ...
                  <b> <nav aria-label="breadcrumb">
                        <ol class="breadcrumb" style="background: #fce6e8;">
                          <li class="breadcrumb-item"><?php echo anchor('user/bangunan','<i class="far fa-edit"></i> Kelola Bangunan'); ?></li>
                ...
                <?php foreach($bangunan as $kd) :?>

                <form method="post" action="<?php echo base_url('user/bangunan/bangunan_update') ?>">
                  <div class="form-group row">
                    <label class="col-sm-4 col-form-label">Nomor Inventaris</label>
                    <div class="col-sm-8">
                      <?php echo form_hidden('id_bangunan', $kd->id_bangunan); ?>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" name="nama" value="<?php echo $kd->nama_bangunan; ?>" class="form-control" required>
                  ...
                  <div class="form-group row">
                   ...
                   <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" name="luas" value="<?php echo $kd->luas_bangunan; ?>" class="form-control" required>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="number" name="lantai" value="<?php echo $kd->jumlah_lantai; ?>" class="form-control" required>
