        ...
        <div class="row">
            ...
            <div class="col-md-6">
              <div class="card mb-4 py-3 border-left-danger">
                <div class="card-body">
                  ...
                  <b> <nav aria-label="breadcrumb">
                        <ol class="breadcrumb" style="background: #fce6e8;">
                          <li class="breadcrumb-item"><?php echo anchor('user/bangunan','<i class="fas fa-qrcode"></i> Kelola Bangunan'); ?></li>
                ...
                <center>
                   <form method="post" action="<?php echo base_url('user/bangunan/print_qrcode_custom') ?>" target="_blank">
                        <div class="form-group">
                          <label class="col-form-label">Masukkan Jumlah</label>
                            <?php echo form_hidden('id_bangunan', $idin->id_bangunan); ?>
