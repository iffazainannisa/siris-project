    ...
    <div id="content-wrapper" class="d-flex flex-column kecil">
      ...
      <div class="alert alert-success" role="alert">
        ...
        <p>Selamat Datang di <b>SISTEM INVENTARIS PMI KOTA SEMARANG</b>, Anda Login Sebagai <strong><?php echo $userku["nama_user"]; ?></strong></br>Apabila ada kesulitan atau data tidak tersedia, hubungi <b>Admin</b></p>
        <hr />
      </div>
        <!-- Content Row -->
        <div class="row">
          ...
          <a class="col-md-3 col-sm-8 mb-4 btn-zoom" href="<?php echo base_url('user/kantor') ?>" style="text-decoration: none;">
          ...
          <!-- Earnings (Monthly) Card Example -->
          <a class="col-md-3 col-sm-8 mb-4 btn-zoom" href="<?php echo base_url('user/mesin') ?>" style="text-decoration: none;">
          ...
          <!-- Earnings (Monthly) Card Example -->
          <a class="col-md-3 col-sm-8 mb-4 btn-zoom" href="<?php echo base_url('user/kendaraan') ?>" style="text-decoration: none;">
          ...
          <a class="col-md-3 col-sm-8 mb-4 btn-zoom" href="<?php echo base_url('user/tanah') ?>" style="text-decoration: none;">
            <div class="card bg-warning shadow h-100 py-2">
             ...
             <a class="col-md-3 col-sm-8 mb-4 btn-zoom" href="<?php echo base_url('user/bangunan') ?>" style="text-decoration: none;">
