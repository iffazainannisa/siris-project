    ...
    <div id="content-wrapper" class="d-flex flex-column bg-picture">
      ...
      <div class="container-fluid">
        <div class="alert bg-content" role="alert">
          <i class="fas fa-plus-square"></i> Tambah Aset Tanah
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
              <div class="card mb-4 py-3 border-left-danger">
                ...
                <form method="post" action="<?php echo base_url('user/tanah/tambah_aksi') ?>">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" name="luas" placeholder="Masukkan Luas Tanah" class="form-control" required>
