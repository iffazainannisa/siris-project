...
<body>
      ...
      <img src="assets/img/bar.png" style="width: 120%;">
       <div class="container">
        ...
        <span style="text-transform: uppercase; "><b>DAFTAR INVENTARIS RUSAK <?php echo $kategori;?><br/><?php echo $bid;?> PMI KOTA SEMARANG</h5></span>
      ...
      <table class="table table-bordered" width="100%">
        ...
        ?>
          <tr>
            ...
            <td style="text-align: center;"><?php echo $iv->jumlah_buruk; ?></td>
