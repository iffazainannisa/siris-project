      ...
      <table class="table table-bordered" width="100%">
        ...
        ?>
          <tr>
            ...
            <td width="6%" style="text-align: left;"><?php echo $iv->no_plat;?></td>
            <td width="5%"><?php echo $iv->nama_status;?></td>
            <td width="5%"><?php echo $iv->lokasi;?></td>
            <td width="5%"><?php echo $iv->merk;?></td>
            <td width="5%"><?php echo $iv->type;?></td>
            <td width="8%"><?php echo $iv->no_rangka;?></td>
            <td width="7%"><?php echo $iv->no_mesin;?></td>
            <td width="5%"><?php echo $iv->tahun_produksi;?></td>
            ...
            <td width="5%"><?php echo $iv->jenis_bbm;?></td>
            <td width="5%"><?php echo $iv->bpkb;?></td>
            <td width="9%"><?php echo $iv->keterangan;?></td>
          </tr>
        <?php endforeach; ?>
        <tr>
          <td colspan="10" style="text-align: right;">Jumlah Total</td>
