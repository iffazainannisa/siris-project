    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div class="container-fluid">
        <div class="alert bg-content" role="alert">
          <i class="fas fa-plus-square"></i> Detail Inventaris Barang Kantor 
        </div>
                ...
                <div class="card-body">
                  ...
                  <b> <nav aria-label="breadcrumb">
                        <ol class="breadcrumb" style="background: #fce6e8;">
                          <li class="breadcrumb-item"><?php echo anchor('admin/barang','<i class="fas fa-search"></i> Kelola Inventaris Barang'); ?></li>
                          <li class="breadcrumb-item active" aria-current="page">Detail Barang Kantor</li>
                        </ol>
                      </nav>
                  </b></h6>
