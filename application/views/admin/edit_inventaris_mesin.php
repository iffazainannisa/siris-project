    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div class="container-fluid">
        <div class="alert bg-content" role="alert">
          <i class="fas fa-plus-square"></i> Edit Inventaris Mesin dan Alat Berat
        </div>
          ...
          <div class="col-md-1"></div>
            <div class="col-md-6">
              <div class="card mb-4 py-3 border-left-danger">
                <div class="card-body">
                  <h6><i class="far fa-edit"></i> <b >Form Edit Inventaris Mesin dan Alat Berat</b></h6>
                  <div class="garis" style="width: 100%; margin-bottom: 2%;"></div>

                 <?php foreach ($inventaris_mesin as $bgn ) : ?>
                <form method="post" action="<?php echo base_url().'admin/mesin/update_mesin'; ?>">
            ...
            <div class="col-md-1"></div>
              ...
              <div class="card mb-4 py-3 border-left-danger">
                <div class="card-body">
                  <h6><i class="far fa-edit"></i> <b >Form Edit Mesin dan Alat Berat</b></h6>
                  <div class="garis" style="width: 100%; margin-bottom: 2%;"></div>
                <?php foreach ($inventaris_mesin as $bgn ) : ?>
              

                <form method="post" action="<?php echo base_url().'admin/mesin/update1'; ?>">
                  <div class="form-group row">
                    <label class="col-sm-4 col-form-label">Nama Barang</label>
                    <div class="col-sm-8">
                       <?php echo form_hidden('id_barang', $bgn->id_barang); ?>
