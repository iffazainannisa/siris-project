    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div class="container-fluid">
        <div class="alert bg-content" role="alert">
          <i class="fas fa-plus-square"></i> Edit Inventaris Barang Kantor
        </div>
          ...
          <div class="col-md-1"></div>
            <div class="col-md-6">
              <div class="card mb-4 py-3 border-left-danger">
                <div class="card-body">
                  <h6><i class="far fa-edit"></i> <b >Form Edit Inventaris Barang Kantor</b></h6>
                  <div class="garis" style="width: 100%; margin-bottom: 2%;"></div>

                 <?php foreach ($inventaris_barang as $bgn ) : ?>
                <form method="post" action="<?php echo base_url().'admin/barang/update_barang'; ?>">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input required="required" type="text" name="nama_barang" class="form-control" value="<?php echo $bgn->nama_barang?>" >
                    </div>
                  </div>
                   ...
                   <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <select name="ruang" class="form-control select2" style="width: 100%;">
                        <option value="<?php echo $bgn->id_ruang;?>"><?php echo $bgn->nama_ruang;?></option>
                        <?php foreach($ruang as $bg) : ?>
                        <option value="<?php echo $bg->id_ruang; ?>"><?php echo $bg->nama_ruang; ?></option>
                        <?php endforeach; ?>
                      </select>
            ...
            <div class="col-md-1"></div>
              ...
              <div class="card mb-4 py-3 border-left-danger">
                <div class="card-body">
                  <h6><i class="far fa-edit"></i> <b >Form Edit Barang kantor</b></h6>
                  <div class="garis" style="width: 100%; margin-bottom: 2%;"></div>
                <?php foreach ($inventaris_barang as $bgn ) : ?>
              

                <form method="post" action="<?php echo base_url().'admin/barang/update1'; ?>">
                  <div class="form-group row">
                    <label class="col-sm-4 col-form-label">Nama Barang</label>
                    <div class="col-sm-8">
                       <?php echo form_hidden('id_barang', $bgn->id_barang); ?>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input required="required" type="number" name="tahun_perolehan" class="form-control" value="<?php echo $bgn->tahun_perolehan?>">
                    </div>
                  </div>
