    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div class="container-fluid">
        <div class="alert bg-content" role="alert">
          <i class="fas fa-plus-square"></i> Edit Inventaris Tanah
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
              <div class="card mb-4 py-3 border-left-danger">
                <div class="card-body">
                  <h4><i class="far fa-edit"></i> <b >Form Edit Inventaris Tanah</b></h4>
                  <div class="garis" style="width: 100%; margin-bottom: 2%;"></div>
                <?php foreach ($inventaris_tanah as $bgn ) : ?>
              

                <form method="post" action="<?php echo base_url().'admin/tanah/update_tanah'; ?>">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input required="required" type="number" name="luas_tanah" class="form-control" value="<?php echo  $bgn->luas_tanah?>">
                    </div>
                  </div>
